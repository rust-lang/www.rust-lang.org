...
community-learn = 学びの場
community-get-in-contact = 連絡先
community-read-about = Rustについてもっと知る
...
community-chat = Rustの開発や一般的な話し合いは、いくつかのチャットプラットフォーム上で行われています。RustのZulipサーバにあるgeneral等のチャンネルを確認いただくか、チームページを見て特定のチームがどこで話し合っているかを確認してみてください。
...
community-standards =
    ...
    <br /><br />
    あなたがコミュニティメンバーにハラスメントを受けているか、または不快にさせられていると感じた場合は、ただちに<a href="mailto:rust-mods@rust-lang.org">Rustモデレーションチーム</a>の誰かに連絡してください。あなたが常連の寄稿者であろうと、新規参入者であろうと、私たちはこのコミュニティをあなたにとって安全な場所にすることに気を配っています。
