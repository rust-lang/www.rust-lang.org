...
policies-licenses-page-title = ライセンス
licenses-license-heading = ライセンス
licenses-license-general-description = Rustプログラミング言語と、このウェブサイトを含むそれ以外の全ての公式プロジェクトは、原則として以下のデュアルライセンスで保護されます：
licenses-apache-v-2-0-link = Apacheライセンスバージョン2.0
licenses-mit-link = MITライセンス
