...
community-twir = Bleib auf dem Laufenden!
community-twir-button = Diese Woche in Rust
community-team-button = schreibe { ENGLISH("community@rust-lang.org") }
community-urlo-header = Nutzer-Forum
community-discourse-button = Besuche das Forum
community-teams-learn = Lerne mehr über die Teams
community-events-header = Veranstaltungen
...
community-conference-lineup = Zum Programm für 2019
