...
tagline = Un langage qui offre à tous le pouvoir { $linebreak } de construire des logiciels fiables et efficace.
...
production-blurb = Des centaines d'entreprises de par le monde utilisent Rust aujourd'hui pour bâtir des solutions rapides, multiplateforme avec un faible usage de ressources. Les logiciels que vous aimez comme <a href="https://hacks.mozilla.org/2017/08/inside-a-super-fast-css-engine-quantum-css-aka-stylo/">Firefox</a>, <a href="https://blogs.dropbox.com/tech/2016/06/lossless-compression-with-brotli/">Dropbox</a>, et <a href="https://blog.cloudflare.com/cloudflare-workers-as-a-serverless-rust-platform/">Cloudflare</a>, utilisent Rust. <strong> Des startup aux grandes sociétés, de l'embarqué au web services scalables.
