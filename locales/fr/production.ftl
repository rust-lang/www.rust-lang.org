...
production-whitepapers = Livres blancs
production-read-whitepaper = Lire le livre blanc
production-npm = Lire comment <a href="https://www.npmjs.com/">npm</a>, qui gère le registre du même nom, a trouvé Rust ennuyeux à déployer.
production-tilde = Apprendre comment Rust aide <a href="http://www.tilde.io/">Tilde</a>, les créateur de <a href="https://www.skylight.io/">Skylight</a>, à permettre un monitoring de performance, riche en fonctionnalités, des applications de leurs clients en utilisant un minimum de ressources.
production-highlights = Faits importants
production-read-more = En lire plus
production-watch-video = Regarder la vidéo
production-dropbox = Plusieurs composants du système central de stockage de fichiers de Dropbox ont été écrits en Rust en tant que partie d'un large projet visant une meilleure efficacité de leurs datacenters. Aujourd'hui, Ils sont utilisés par tous les stockages Dropbox, servant plus de 500 millions d'utilisateurs.
