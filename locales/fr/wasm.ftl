...
wasm-js-augment-description = Le rêve de WebAssembly n'est pas de tuer JavaScript mais de fonctionner à ses côtés, pour aider les taches lourdes en calcul ou de bas niveaux &mdash; taches qui bénéficient de l'orientation de Rust vers les performances.
