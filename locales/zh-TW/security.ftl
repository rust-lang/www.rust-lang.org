...
security-disclosure-description =
    ...
    <ol>
      ...
      <li>對所有仍在維護的發行版本進行修復，這些修復不會推送到公共倉庫，而是保留在本地，等待發怖</li>
      <li>過封鎖期後<a href="{ -rustlang-security-announcements-google-groups-forum-href }">Rust 安全公告郵件列表</a>將發布一份公告副本。這些更改會提交至公共倉庫，新的程序會部署至 rust-lang.org。在收到郵件列表通知的 6 小時內，Rust blog 將發怖該通報的副本。</li>
    </ol>
