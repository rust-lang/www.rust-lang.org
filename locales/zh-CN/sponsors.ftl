...
sponsors-arm = ARM 正在为 Rust 的 CI 基础架构提供构建器，以便在 AArch64 上测试编译器。
...
sponsors-github = GitHub 很荣幸成为 Rust 项目及其生态系统核心部分的所在地，以及极耗资源的 rust-lang / rust 储存库背后的 build / CI基础架构。
