...
policies-media-guide-page-title = 媒体使用手册
...
media-guide-rust-trademarks-rust-img-alt = rust 标志
media-guide-rust-trademarks-cargo-img-alt = cargo 标志
...
media-guide-helping-out-link = 发送邮件至 Rust 核心团队
