...
embedded-pitch-concurrency-description = Rust 使得线程之间不可能意外地共享状态。无论使用哪种喜欢的方式实现并发，都能获得 Rust 提供的强力保障。
embedded-pitch-interop-alt = 握手
embedded-pitch-interop-heading = 互操作性
embedded-pitch-interop-description = 可将 Rust 集成到现有的 C 代码库中，也可利用现有的 SDK 编写 Rust 应用程序。
...
embedded-get-started-embedonomicon-description = 探究基础性嵌入式开发库的底层原理。
...
embedded-testimonials-airborne-quote = 在 Airborne Engineering Ltd，我们最近用 Rust 语言写了以太网 bootloader 项目<a href="https://github.com/airborneengineering/blethrs">blethrs</a>，用于内部数据采集系统。<b>Rust 是一门有前途的语言，我们对于将它用于未来无论是嵌入式还是其他类的项目，都感到兴奋。</b>
