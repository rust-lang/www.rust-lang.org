...
wasm-why-rust-predictable-alt = Zębatki
wasm-why-rust-predictable-heading = Przewidywalna wydajność
wasm-why-rust-small-code-alt = Mikroskop
wasm-why-rust-small-code-heading = Mały rozmiar kodu
wasm-why-rust-amenities-alt = Bagaż
wasm-why-rust-amenities-heading = Nowoczesne udogodnienia
