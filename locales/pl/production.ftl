...
production-page-title = Na produkcji
...
production-read-more = Czytaj Więcej
production-watch-video = Obejrzyj Film
production-dropbox = Jako pierwszy krok w ramach większego projektu, mającego za cel lepszą wydajność, wiele podstawowych komponentów systemu przechowywania plików Dropbox zostało napisane w Ruście. Obecnie wszystkie usługi Dropbox korzystają z tych komponentów, obsługując ponad 500 milionów użytkowników.
...
production-license-link = Zasady: Licencje

## templates/production/users.hbs

production-users-page-title = Rust na produkcji
