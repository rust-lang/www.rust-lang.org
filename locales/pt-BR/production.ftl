...
production-page-title = Produção
production-whitepapers = Publicações técnicas
production-read-whitepaper = Leia a publicação técnica
production-npm = Leia como o <a href="https://www.npmjs.com/">npm</a>, que mantém o Registro de Pacotes JavaScript do mesmo nome, descobriu a simplicidade de rodar Rust em produção.
production-tilde = Aprenda como Rust ajuda <a href="http://www.tilde.io/">Tilde</a>, criadores da <a href="https://www.skylight.io/">Skylight</a>, a usar o mínimo de recurso para proporcionar monitoramento performático com muitas funcionalidades para as aplicações de seus clientes.
production-highlights = Destaques
production-read-more = Leia Mais
production-watch-video = Assista o Vídeo
production-dropbox = Vários componentes do sistema principal de armazenamento de arquivo da Dropbox foram escritos em Rust como um dos passos de um grande projeto de otimização na eficiência de datacenters. Atualmente o sistema é usado por todo o armazenamento da Dropbox, servindo mais de 500 milhões de usuários.
production-dropbox-alt = logo da Dropbox
...
production-users-page-title = Usuários em produção
