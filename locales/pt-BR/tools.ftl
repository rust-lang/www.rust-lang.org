...
install-rustup64-button = Baixar <span class="nowrap">rustup-init.exe</span> <span class="nowrap">(x64)</span>
install-rustup-arm64-button = Baixar <span class="nowrap">rustup-init.exe</span> <span class="nowrap">(ARM64)</span>
