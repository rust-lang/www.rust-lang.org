...
policies-page-title = Políticas
policies-page-description = Essa página apresenta uma lista completa das políticas do projeto Rust.
policies-code-of-conduct-link = Código de Conduta
policies-licenses-link = Licenças
policies-media-guide-link = Política de uso de Logo e Guia de Mídias
