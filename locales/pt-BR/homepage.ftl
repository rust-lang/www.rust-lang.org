...
language-values-productivity = Produtividade
language-values-productivity-blurb = Rust possui uma ótima documentação, um compilador amigável com mensagens de erros úteis, e ferramental de primeira qualidade &mdash; uma ferramenta integrada de compilação e gerenciamento de pacotes, suporte inteligente para múltiplos editores com autocompleção e inspeções de tipos, um formatador automático, e muito mais.
...
domains-embedded-blurb =
    ...
    Rust tem a solução.
domains-embedded-alt = um chip para sistemas embarcados
