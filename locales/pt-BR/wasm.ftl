...
wasm-why-rust-small-code-description = Código pequeno significa páginas carregando mais rápidamente. <code>wasm</code> gerado por Rust não inclui nada extra, como um <i>garbage collector<i>. Otimizações avançadas e técnica de <i>tree shaking</i> para remoção de código não usado.
...
wasm-js-toolchains-description = Publique pacotes de Rust WebAssembly em registros de pacotes como npm. Integre com o webpack, Parcel, e outros. Mantenha seus pacote com ferramentas como <code>npm audit</code> e Snyk.
