...
networking-production-testimonial-1aim = O poderoso sistema de tipos de Rust nos fornece refatoração segura e identificação de muitas categorias de erros durante a compilação. O seu pouco uso de recursos e a alta performance, juntamente com suas garantias de uso de memória de forma segura e pelo sólido tratamento de erros, o torna perfeito para escrever lógicas de negócio críticas e complexas nos nossos serviços. A grande estabilidade faz com que nossas aplicações em Rust sejam a última parte da plataforma que precisamos nos preocupar. Estamos rodando quase 100% dos nossos serviços em Rust desde o final de 2015 e Rust nunca nos decepcionou.
