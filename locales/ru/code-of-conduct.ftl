...
coc-conduct-description =
    <ul>
      ...
      <li>Мы исключим вас из взаимодействия, если вы унижаете или оскорбляете кого-либо. Это не приветствуется. Мы понимаем термин «домогательства», как определяется в <a href="http://citizencodeofconduct.org/">Citizen Code of Conduct</a>. Если у вас нет ясности относительно того, что может быть включено в эту концепцию, пожалуйста, прочитайте их определение. В частности, мы не терпим поведения, которое присутствует у людей из социально маргинализированных групп.</li>
      ...
      <li>Точно так же не приветствуются спам, троллинг, флейм, травля или другие виды кражи внимания.</li>
    </ul>
