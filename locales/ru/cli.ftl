...
cli-pitch-solid-description =
    Даже если вы просто пишете маленький одноразовый
    скрипт, то вы можете быть уверены, что он будет быстрым, легко тестируемым и даст
    полезный вывод.
...
cli-pitch-manuals-description = Создавайте справочные страницы для вашего приложения автоматически. Просто упакуйте сгенерированные файлы, и готово.
