...
governance-roadmap-read = Читать дорожную карту на 2019 год
governance-teams-header = Команды
governance-wgs-header = Рабочие группы

## governance/index-team.hbs

governance-members = Участники и контакты

## governance/group-team.hbs

governance-team-email = Email { $teamname }
governance-team-repository = Репозиторий { $teamname }
governance-team-discord = { $channel } в Discord
governance-team-zulip = { $stream } в Zulip
