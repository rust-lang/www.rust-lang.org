...
sponsors-arm = ARM предоставляет CI инфраструктуру для проверки компилятора на архитектуре AArch64.
...
sponsors-integer32 = Integer 32 финансирует внутренний форум и мониторинг crates.io.
...
sponsors-github = GitHub имеет честь быть домом для проекта Rust и основных частей его экосистемы, а также инфраструктуры сборки/CI, стоящей за чрезвычайно ресурсоёмким хранилищем rust-lang/rust.
