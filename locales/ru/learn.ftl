...
learn-begin = Начать изучение Rust
learn-book = Ласково называемая "Книга", <cite>"Язык программирования Rust"</cite> даст вам обзор языка начиная с базовых принципов. По ходу чтения вы создадите несколько проектов и в конце вы получите твёрдое понимание языка.
learn-book-button = Читать книгу!
learn-rustlings = Другой вариант, Rustlings, поможет вам в установке и настройки инструментов Rust, и обучит вас основам чтения и написания кода на Rust. Это альтернатива книге "Rust на примерах", которая работает с вашим собственным окружением.
learn-rustlings-button = Пройдите курс Rustlings!
learn-rbe = Если чтение сотен страниц о языке не ваш стиль, то вам стоит взглянуть на "Rust на примерах" ("Rust By Example", RBE). Пока "Книга" большим количеством слов рассуждает о коде, RBE показывает куски кода и сводит рассуждения к минимуму. Она также содержит упражнения!
learn-rbe-button = Перейти в Rust by Example!
learn-use = Растите с Rust
...
learn-doc-edition-button = Руководство по редакции языка
...
learn-doc-error = Подробные объяснения ошибок, которые вам может написать компилятор Rust.
...
learn-install-fmt-clippy = Вы можете установить средство форматирования кода (Rustfmt) с помощью команды <code>rustup component add rustfmt</code>, и дополнительный статический анализатор (Clippy) с помощью команды <code>rustup component add clippy</code>.
...
learn-dependencies-steps =
    ...
    <p>Вы увидтиле, что эта команда создала новый файл, <code>Cargo.lock</code>. Этот файл представляет собой журнал точных версий зависимостей, которые мы используем локально.</p>
...
learn-ferris =
    ...
    <p>Вы можете найти больше изображений Ферриса на <a href="http://rustacean.net/">http://rustacean.net/</a>.
