...
language-values-performance-blurb = Rust невероятно быстр и эффективен по использованию памяти: без рантайма или сборщика мусора он может обеспечить работу критичных для производительности сервисов, запускаться на страиваемых устройствах и легко интегрироваться с другими языками.
language-values-reliability = Надёжность
language-values-reliability-blurb = Богатая система типов Rust и модель владения гарантируют безопасность памяти и потокобезовасность &mdash; и позволяют устранить множество классов ошибок во время компиляции.
...
domains-blurb = В 2018 году, сообщество Rust приняло решение расширить присутствие языка для нескольких областей (смотри <a href="https://blog.rust-lang.org/2018/03/12/roadmap.html">roadmap на 2018 год</a>). Для этого вы можете найти множество высококачественных пакетов и потрясающие руководства о том, как начать.
...
domains-wasm-blurb = Используйте Rust для перезарядки вашего JavaScript, по одному модулю за раз. Опубликуйте в npm, упакуйте с webpack и ты уезжаешь на гонки.
domains-wasm-alt = шестерёнка в виде элементов пазла
domains-net = Сетевое программирование
domains-net-blurb = Предсказуемая производительность. Крошечный ресурсный след. Потресающая надежность. Rust отлично подходит для сетевых сервисов.
domains-net-alt = облако с узлами
domains-embedded = Встраиваемая система
domains-embedded-blurb =
    Ориентируетесь на низкоресурсные устройства?
    Нужен низкоуровневый контроль без отказа от высокоуровневых удобств?
    Rust предоставит это.
domains-embedded-alt = чип встроенного устройства

## components/panels/get-involved.hbs

get-involved = Прими участие
get-involved-read-rust = Читай про Rust
get-involved-read-rust-blurb = Мы любим документацию! Посмотрите книги, доступные онлайн, как и ключевые блоги и пользовательские руководства.
get-involved-read-rust-link = Читать книгу
get-involved-watch-rust = Смотри про Rust
...
get-involved-contribute-blurb = Rust - действительно работа сообщества, и мы приветствуем вклад как любителей, так и тех, кто использует его в производстве, от новичков, до профессионалов. Помогите нам улучшить опыт работы с Rust!
