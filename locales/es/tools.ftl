...
tools-rustup-windows = Parece que estás usando Windows. Para instalar Rust, descarga y ejecuta este instalador, y sigue las instrucciones que aparecen en pantalla.
