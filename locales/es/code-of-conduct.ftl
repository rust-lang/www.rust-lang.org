...
coc-conduct-description =
    ...
    <ul>
      ...
      <li>Se te apartará de interaccionar con el resto si insultas, menosprecias o acosas a alguien. Este comportamiento no se admite. Nuestra interpretación del término "acoso" (<em>harassment</em>) está en línea con la definición del <a href="http://citizencodeofconduct.org/">Citizen Code of Conduct</a>; si tienes dudas respecto a qué se incluye en este concepto, lee dicha definición. En particular, no toleramos comportamientos que excluyan a grupos marginados socialmente.</li>
