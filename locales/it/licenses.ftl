...
licenses-license-general-description = Il linguaggio di programmazione Rust e tutti gli altri progetti ufficiali, incluso il sito web, sono generalmente coperti da doppia licenza:
...
licenses-license-specific-description =
    ...
    <p>Per domande o dubbi specifici su come il progetto Rust o altri progetti associati siano licenziati, contatta pure il Rust Core Team</p>
