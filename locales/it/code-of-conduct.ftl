...
coc-moderation-description =
    <p>Queste sono le linee guida per il mantenimento degli standard di condotta della nostra community. Se pensi che una discussione abbia bisogno di essere moderata, per favore contatta il { $coc-rust-moderation-team-anchor }.</p>
    <ol>
