...
governance-roadmap-read = Leggi la Roadmap 2024
governance-teams-header = I Team
governance-wgs-header = I Working Group

## governance/index-team.hbs

governance-members = Membri e Contatti

## governance/group-team.hbs

governance-team-email = Manda un'email al { $teamname }
governance-team-repository = repository { $teamname }
governance-team-discord = { $channel } su Discord
governance-team-zulip = { $stream } su Zulip
governance-user-github = GitHub: { $link }
governance-user-team-leader = Team leader
governance-members-header = Membri
governance-alumni-header = Alumni
governance-alumni-thanks = Vogliamo rigraziare i membri che hanno partecipato in passato per il loro inestimabile contributo!
