...
production-whitepapers = Whitepaper
production-read-whitepaper = Leggi il whitepaper
production-npm = Scopri come <a href="https://www.npmjs.com/">npm</a>, che gestisce l'omonimo egistro JavaScript, ha trovato estremamente semplice usare Rust per fare deploy.
...
production-highlights = In evidenza
