...
community-get-in-contact = Contattaci
community-read-about = Tieniti aggiornato
...
community-chat = Lo sviluppo di Rust e le discussioni in generale si tengono su molteplici piattaforme. Dai un'occhiata ai vari canali sul server Zulip Rust, oppure visita la pagina per trovare i ritrovi dei vari team.
