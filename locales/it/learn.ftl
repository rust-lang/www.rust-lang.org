...
learn-rbe = Se leggere centinaia di pagine di manualistica non è il tuo stile, allora "Rust by Example" fa per te. Il Libro parla di codice in maniera piuttosto prolissa, mentre RBE ti mostra il codice con pochi fronzoli. E include anche degli esercizi!
learn-rbe-button = Vai su Rust by Example!
learn-use = Diventa esperto con Rust
learn-doc-heading = Leggi la principale documentazione
learn-doc = Tuuta la documentazione è anche disponibile in locale; tramite il comando <code>rustup doc</code> si aprirà una pagina nel browser, non occorre alcuna connessione di rete!
...
learn-domain-cli = Impara come creare utili applicazioni da linea di comando in Rust.
...
learn-install-fmt-clippy = Puoi installare il tool per formattare il codice (Rustfmt) con <code>rustup component add rustfmt</code> e quello per formattare il codice (Clippy) con <code>rustup component add clippy</code>.
