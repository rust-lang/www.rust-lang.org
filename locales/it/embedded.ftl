...
# Page Title
what-embedded-page-title = Dispositivo embedded
...
embedded-pitch-interop-description = Integra Rust nella tua base di codice esistente in C o con un SDK che già utilizzi per scrivere un'applicazione in Rust.
embedded-pitch-portability-alt = Carrello con valigia
embedded-pitch-portability-heading = Portabilità
embedded-pitch-portability-description = Scrivi una libreria una sola volta e usala in più sistemi, dal minuscolo microcontroller ai potenti SBC.
...
embedded-showcase-quote = "Quando ho cominciato a usare Rust, creato da Mozilla, ero estremamente interessato. Rust è un nuovo linguaggio di programmazione, il cui motto è 'sicuro, veloce, concorrente &ndash; scegline tre.' Ha anche un futuro garantito, grazie a una potente community dedicata."
...
embedded-get-started-discovery-book-description = Impara a sviluppare su embedded da zero &mdash; con Rust!
...
embedded-get-started-embedded-rust-book-description = Conosci già lo sviluppo su embedded? Mettici dentro Rust e comincia a raccoglierne i benefici.
...
embedded-testimonials-sensirion-quote = In Sensirion abbiamo di recente usato Rust per creare un embedded demonstrator del nostro <a href="https://sensirion-automotive.com/products#PM2_5">Particulate Matter Sensor</a>. Grazie alla semplicità con cui si può fare cross-compiling e alla disponibilità di molti pacchetti di alta qualità su crates.io <b>siamo riusciti a mettere insieme rapidamente un robusto demonstrator.</b>
...
embedded-testimonials-49nord-quote = { "[" }Rust] ci ha permesso di consegnare software più velocemente e di miglior qualità di quello che pensavamo fosse possibile. Grazie a Rust, possiamo dare per scontato la sicurezza nella gestione della memoria; inoltre, i benefici di un linguaggio zero-overhead, associato a un sofisticato type system, ci aiutano a sviluppare software semplice da mantenere. <b>Rust soddisfa i nostri clienti, così come i nostri ingegneri.</b>
...
embedded-testimonials-terminal-tech-quote = <b>Crediamo che sia davvero forte poter usare un moderno linguaggio in ambito embedded</b> dove di solito non c'è alternativa al C/C++
