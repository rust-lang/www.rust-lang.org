...
security-reporting-description =
    Questa pagina è stata tradotta dalla community al meglio delle nostre conoscenze. Si consiglia di fare riferimento alla <a href="https://www.rust-lang.org/policies/security">versione in inglese</a> di questo documento per la versione ufficiale.
