...
cli-pitch-solid-img-alt = Scudo con spunta
cli-pitch-solid-heading = Robusto e veloce
...
cli-pitch-machines-description = In aggiunta a quelli per parlare con gli umani, Rust ha ottimi strumenti che ti aiutano a parlare con le macchine.
cli-pitch-machines-link = Comunica con le macchine
cli-pitch-logging-img-alt = 3 ceppi di legno accatastati l'uno sull'altro
cli-pitch-logging-heading = Logging flessibile
cli-pitch-logging-description = E' facile aggiungere il logging, ed è ancora più facile da configurare per target differenti e differenti stili.
cli-pitch-logging-link = Logga, traccia, capisci

## templates/components/what/cli/maintainable.hbs

cli-maintainable-heading = Una base di codice gestibile
cli-maintainable-errors-img-alt = struttura di una applicazione cli
cli-maintainable-errors-heading = Cattura gli errori <em>ora</em>
cli-maintainable-errors-description = Cosa succede se il file di configurazione non si trova o è corrotto? E se il valore di una variabile di sistema non è impostata? Sono facili casi da dimenticare! Ma grazie alla propria gestione errori e al design delle proprie librerie, Rust ti farà presente questi casi ancora prima di eseguire la tua applicazione.
cli-maintainable-errors-link = Gestione degli errori di Rust
cli-maintainable-refactoring-img-alt = la command line non è una scienza aerospaziale
cli-maintainable-refactoring-heading = Facile da estendere
cli-maintainable-refactoring-description = Rust ti aiuta a gestire il codice con flessibilità. Inizia partendo da un singolo file e quando hai bisogno di nuove feature, fai pure refactor in tranquillità sapendo che non romperai nulla.
cli-maintainable-refactoring-link = Rust Refactoring
