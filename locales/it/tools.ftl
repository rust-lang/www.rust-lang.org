...
tools-rustup-windows = Sembra che tu stia usando Windows. Per installare Rust scarica e fai partire il seguente eseguibile e segui le istruzioni a schermo.
