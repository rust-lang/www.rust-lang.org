...
media-guide-art-license-heading = Görsel Lisansı
media-guide-art-license-description = <p>Rust ve Cargo logoları (bitmap ve vektör) Mozilla'ya aittir ve <a href="https://creativecommons.org/licenses/by/4.0/">Atıf 4.0 Uluslararası (CC-BY) lisansıyla </a> dağıtılır. Bu en hoşgörülü atıf lisansı olmakla birlikte, herhangi bir amaç için tekrar kullanımı ve değişime izin vermektedir. Dağıtıcıların "uygun haklarını vermeleri, lisansa yönlendiren bir bağlantı paylaşmaları ve yapıldıysa, değişiklikleri belirtmeleri" zorunludur. <strong>Bu logoların, Rust ve Cargo isimlerinin kullanımı da marka hakları tarafından yönetilir. Markamızın politikası aşağıda tanımlanmıştır</strong>.</p>

## Trademark policy

media-guide-trademark-policy-heading = Ticari Marka Politikası
...
media-guide-rust-trademarks-heading = Rust Markaları
media-guide-rust-trademarks-description =
    <p>Rust programlama dili, çekirdek ekip tarafından yönetilen, açık kaynak kodlu bir topluluk projesidir. Rust ve Cargo isim ve logo haklarına sahip olup, onları koruyan Mozilla vakfı sayesinde varlığını sürdürmektedir. Bu belge Rust programlama diline özel kullanım hakları ile ilgili bilgi taşımakla birlikte, 
    ticari marka haklarını kullanmak isteyen insanlar için hangi durumlarda hangi kullanımlar için izin alınması gerektiği ile ilgili sık karşılaşılabilecek örneklerle birlikte açıklamalar da içerir. Bu döküman resmi, tüm Mozilla ticari marka haklarını da yöneten <a href="https://www.mozilla.org/foundation/trademarks/policy/">Mozilla ticari marka hakları politikasını</a> destekler niteliktedir.</p>
    <p>Rust ticari marka hakları iki marka kelimesi ve iki logoyu kapsar:</p>
    <ul>
     <li>Rust</li>
     <li>Cargo</li>
...
media-guide-tm-use-basics-description =
    ...
    <p>Bu markalar şu durumlarda kullanılamaz:</p>
    <ul>
     <li>başka bir programlama diline atıfta bulunuyorsa</li>
     <li>yanıltıcı bir anlama gelebilecek alakasız modüller, araçlar, belgelendirmeler veya Rust programlama dili hakkında diğer kaynaklar</li>
     <li>Rust programlama dilinin açık kaynaklı ve kullanmanın ücretsiz olup olmadığı konusunda topluluğun kafasını karıştırıyorsa</li>
    </ul>
...
media-guide-tm-use-explicit-approval-description =
    <ul>
      <li> Rust programlama dilinin veya Cargo paket yöneticisinin değiştirilmiş bir versiyonunun dağıtılması ve Rust veya Cargo olarak adlandırılması, Rust çekirdek ekibinden açık ve yazılı izin gerektirir. Değişikliklerin (1) nispeten küçük ve (2) son kullanıcılara net bir şekilde iletildiği sürece, bu kullanımlara genellikle izin verilir. </li>
      <li> Tişörtlerin, şapkaların ve diğer sanat eserlerinin veya mallarının satılması, Rust çekirdek ekibinden açık ve yazılı izin gerektirir. Bu kullanımlara genellikle (1) malın hiçbir şekilde Rust projesinin resmi bir parçası olmadığı ve (2) kârların Rust projesine fayda sağlayıp sağlamadığı açıkça bildirildiği sürece izin verilir. </li>
      <li> Rust ticari markalarını yukarıda belirtilenler dışında başka bir ticari marka içinde kullanmak, Rust çekirdek ekibinin yazılı iznini gerektirir. </li>
    </ul>
