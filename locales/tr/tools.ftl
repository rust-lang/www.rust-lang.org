...
tools-editor-support-description =
    ...
    <a href="https://github.com/rust-analyzer/rust-analyzer">rust-analyzer</a> kullanarak yapabilirsiniz.
...
install-rustup64-button = <span class="nowrap">rustup-init.exe</span> indir <span class="nowrap">(x64)</span>
install-rustup-arm64-button = <span class="nowrap">rustup-init.exe</span> indir <span class="nowrap">(ARM64)</span>
