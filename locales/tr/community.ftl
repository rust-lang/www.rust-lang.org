...
community-chat = Rust'ın geliştirilmesi ve genel konuşmalar çeşitli sohbet platformlarında gerçekleşir. Genel kanallar ve daha fazlası için Rust Zulip sunucusuna göz atın veya ekipler sayfasından hangi takımların nerede buluşacağına bakın.
...
community-standards =
    ...
    hissediyorsanız lütfen bir an önce <a href="mailto:rust-mods@rust-lang.org">Rust Yönetim Ekibi</a>
