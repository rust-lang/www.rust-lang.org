...
community-team-button = community@rust-lang.org adresine e-posta gönder
...
community-irlo-header = İç Forum
community-irlo = Rust İç Forumu, Rust'ın geliştirilmesi&ndash; derleyici, dilin tasarımı ve standart kütüphane dahil olmak üzere bu konuların tartışıldığı yerdir.
community-chat-header = Sohbet platformları
community-chat = Rust'ın geliştirilmesi ve genel konuşmalar çeşitli sohbet platformlarında gerçekleşir. Genel kanallar ve daha fazlası için Rust Discord sunucusuna göz atın veya ekipler sayfasından hangi takımların nerede buluşacağına bakın.
community-teams-learn = Ekipler hakkında daha fazla bilgi edinin
community-events-header = Etkinlikler
...
community-event-run =
    <p>
    Rust büyüdükçe insanların yerel etkinlik düzenlemesine yardım etmek için heyecanlıyız.
    Rust Etkinlik Ekibi; kurcalayıp öğrenden tutun, buluşmalara ve konferanslara yardım etmek için her zaman hazırdır.
    </p>
    <p>
...
community-standards = Kendimizi cinsiyet, cinsel yönelim, engel, etnik, din veya benzer kişisel özellik gözetmeksizin; samimi, güvenli ve misafirperver bir ortam hazırlamaya adadık. <a href={ baseurl }>Davranış kurallarımız</a>, tüm resmi Rust forumlarındaki davranış standartlarını belirler.
