...
governance-team-docs-description = Rust'ın fantastik belgelendirmesi olduğundan emin olur
...
governance-team-devtools-name = Geliştirici araçları takımı
...
governance-team-libs-name = Kütüphane takımı
...
governance-team-wg-rustfix-description = cargo-fix'i geliştirir ve diğer takımların bir temas noktası olur.
